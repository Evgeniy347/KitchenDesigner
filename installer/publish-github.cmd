...
REM ---- тело релиза: как скачать + обход SmartScreen (генерим через PS, UTF-8) ----
set "NOTES=%TEMP%\kd-release-notes.!TAG!.md"
powershell -NoProfile -ExecutionPolicy Bypass -File "%installerDir%make-release-notes.ps1" -Version "!VER!" -SetupName "KitchenDesigner-Setup-!VER!-x64.exe" -OutFile "!NOTES!"
