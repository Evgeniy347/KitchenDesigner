...
#  изменённым путям — это подсказка, чтобы отбросить не-десктоп (tests/docs)
#  и понять, к какой фиче относятся багфиксы (их в релиз НЕ берут,
...
Write-Host '# Игнор: Assets/Tests, docs/, Packages/.*'
