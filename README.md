...
| **Мебель** | Прямоугольный стол, радиусный стол, табуретка, стул, диван, кровать, пуфик, ножка, винтовая опора, мойка |
...
| **Сантехника** | Унитаз-компакт, инсталляция (подвесной унитаз с панелью смыва), ванна с изменяемыми размерами, настенный смеситель, душевая стойка с тропическим душем |
| **Помещение** | Короб, стена, окно, дверь, пол, источник света, розетка, выключатель |
...
| **Связи выключателей** | В свойствах выключателя — список управляемых им светильников. Прицел рядом со списком включает выбор прямо в сцене: от выключателя за курсором тянется пунктир, клик по светильнику связывает их, а на время выбора видны все связи всех выключателей. Связь многие-ко-многим: светильник горит, если включён хотя бы один связанный с ним выключатель |
...
- **Первый запуск** открывает демонстрационный проект — чтобы было что покрутить,
  не собирая кухню с нуля. Менять его на месте нельзя: любая правка предложит
  сохранить копию в свою папку, и дальше проект правится как обычный.
