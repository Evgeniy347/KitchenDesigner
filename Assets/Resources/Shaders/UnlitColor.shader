Shader "Hidden/KD/UnlitColor"
{
    ...
    // деталь и обязан прятаться вместе с ней. Поверх всего рисуют только те,
    // кому надо ответить «вот эта деталь, где бы она ни лежала»: ручки
    // трансформации и прокрас детали, названной пунктом списка (HoverTint).
    Properties
    {
