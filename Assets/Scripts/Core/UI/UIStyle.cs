...
namespace KitchenDesigner.Core.UI
{
    ...
    public static class UIStyle
    {
        ...
        /// <summary>Подсветка стороны на самой детали в 3D. Ярко-красная: на
        /// светлой текстуре детали жёлтая заливка почти не читалась. Всё ещё
        /// полупрозрачная — под накладкой должна угадываться сама деталь.</summary>
