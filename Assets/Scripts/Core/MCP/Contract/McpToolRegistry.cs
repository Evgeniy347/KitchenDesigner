    ...
    public static class McpToolRegistry
    {
        public static readonly IReadOnlyList<McpToolDef> Tools = new List<McpToolDef>
        {
            ...
            new McpToolDef("create_elements", "Create elements (batch)",
                "Create one or MANY elements in ONE call. Each item: unique name, type (board | wall | floor | facade | assembled_facade | radial_shelf | drawer | table | radius_table | pillar | window | door, default board), x/y/z in METERS, width/height/depth in MILLIMETERS, plus type-specific fields (gaps, fill, drawer params, ...). Atomic: if ANY item is invalid, NOTHING is created. Whole batch is ONE undo step.",
