...
namespace KitchenDesigner.Core.MCP.Contract
{
    public static class McpToolRegistry
    {
        public static readonly IReadOnlyList<McpToolDef> Tools = new List<McpToolDef>
        {
            ...
            new McpToolDef("rename_element", "Rename element",
                "Rename a board, facade, wall, table, drawer or any other element. The new name must be unique among all elements. Corresponding GameObject is renamed too.",
                McpToolKind.Write, typeof(ParamsRenameElement)),
