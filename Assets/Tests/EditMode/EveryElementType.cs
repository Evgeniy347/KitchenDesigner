...
public static class EveryElementType
{
    public static readonly (Type type, Func<string, GameObject> make)[] Makers =
    {
        ...
        (typeof(SocketElement), n => ElementFactory.CreateSocket(WallDeviceSpec.Clamped(97, 83, 13, 2), n, Vector3.zero)),
        (typeof(LightSwitchElement), n => ElementFactory.CreateLightSwitch(WallDeviceSpec.Clamped(89, 91, 17, 3), false, new[] { "Люстра" }, n, Vector3.zero)),
        ...
        (typeof(PipeElbowElement), n => ElementFactory.CreatePipeElbow(n, Vector3.zero)),
        (typeof(PipeCouplingElement), n => ElementFactory.CreatePipeCoupling(n, Vector3.zero)),
        (typeof(PipeTeeElement), n => ElementFactory.CreatePipeTee(n, Vector3.zero)),
        (typeof(PipeCapElement), n => ElementFactory.CreatePipeCap(n, Vector3.zero)),
