...
/// тройника — 118,655 мм, а длина трубы целое число миллиметров: после ресайза
/// ResizeHandleManager кладёт результат на мм-сетку (MmGrid.Snap), и труба длиной
/// 118 мм, севшая заподлицо на тройник, не достаёт до отвода 0,65 мм — при допуске
/// стыка 0,5 мм. Отвод показывает один порт занятым, второй пустым.</summary>
[TestFixture]
