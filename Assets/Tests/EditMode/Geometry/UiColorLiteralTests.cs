...
namespace KitchenDesigner.Tests.Geometry
{
    ...
    public class UiColorLiteralTests
    {
        ...
        private static readonly (string file, int ceiling, string why)[] Budgets =
        {
            ...
            ("HierarchyPanelUI.cs", 8,
                "фон строк дерева и полоса прокрутки: токенов ряда и скроллбара в UIStyle нет"),
            ("IconFactory.cs", 5,
                "рисование иконок в текстуру: чернила и прозрачный фон, а не палитра панелей"),
            ("IssueTableView.cs", 3,
                "полоса прокрутки и прозрачный ряд — копия той же тройки, что в HierarchyPanelUI"),
            ...
            ("SpecificationPanelUI.cs", 4,
                "разделитель и полоса прокрутки — третья копия той же тройки"),
            ("StatusBarUI.cs", 1,
