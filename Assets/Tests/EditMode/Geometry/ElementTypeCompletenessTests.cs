...
namespace KitchenDesigner.Tests.Geometry
{
    ...
    public class ElementTypeCompletenessTests
    {
        ...
        {
            ("изометрический скриншот-тест", "AssembledFacadeElement",
             "пазы и заполнение сборного фасада не покрыты ни одним снимком"),
            ("изометрический скриншот-тест", "CooktopElement",
             "варочная рисуется только внутри столешницы, отдельного снимка нет"),
            ("изометрический скриншот-тест", "DishwasherElement",
             "техника с фасадом-хозяином: снимка нет"),
            ("изометрический скриншот-тест", "LightSourceElement",
             "светильник виден только в фоторежиме, изометрии у него нет"),
            ("изометрический скриншот-тест", "OvenElement",
             "духовка: снимка нет"),
