...
public class SofaElementTests
{
    ...
    public void Sofa_Defaults_AreTheAgreedTwoThousandByEightHundredByNineHundred()
    {
        ...
        Assert.AreEqual(new Vector3Int(2000, 800, 900), sofa.DimensionsMM,
            ...
            + "снята с фотографии: 400 мм глухого основания плюс 400 мм спинки");
        Assert.AreEqual(400, SofaElement.DefaultSeatHeightMM,
            "верх основания на 400 мм — на фотографии цоколь занимает примерно половину "
            + "общей высоты");
    }
