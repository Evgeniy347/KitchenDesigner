...
/// и три дефекта ниже были подтверждены на живой сцене: метры во входном контракте
/// шести инструментов, незамкнутый цикл get → edit_elements → get и смешанные единицы
/// в одном объекте ответа.
///
/// Сторожа здесь — итог миграции «мм — единственная единица внешнего контракта»
/// (2026-09-06): стоит любому из них покраснеть, и перепутать метры с миллиметрами
/// снова можно молча, без отказа валидации, со сдвигом элемента на три порядка.</summary>
