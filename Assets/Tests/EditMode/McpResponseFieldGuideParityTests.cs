...
public class McpResponseFieldGuideParityTests
{
    private static readonly Dictionary<string, string> UndocumentedForNow =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["edgeSides"] = "явные решения человека по торцам «L1:on; W1:off»: on — кромка есть вопреки расчёту, off — кромки нет вопреки расчёту; null, когда все четыре стороны в авто",
