...
/// валидации поехало.
///
/// Зачем: этап 7 плана (<c>docs/GEOMETRY-EXTRACTION-PLAN.md</c>) выносит
...
/// реже сети снэпа. Этот файл закрывает дыру ДО начала переноса.
///
...
public class ValidationInvariantTests
{
    ...
    private static readonly (string Key, int Expected)[] Baseline =
    {
        ...
        // с зазором 40 мм на сторону (допуск 12,5) и 63 столкновения траектории
