...
| Покупные изделия (техника, сантехника, электрика, светильники) — считаются штуками | OvenElement, DishwasherElement, SocketElement, LightSwitchElement, LightSourceElement, BathMixerElement, BathtubElement — каждый IQuantifies, одна строка «1 шт» через PurchasedGoodsSpecItems (Pure/Elements — раздел «Покупные изделия», SpecUnit.Pieces); ElementSpecCoverage.IsCovered — единственное описание правила «покрыт ведомостью» (IQuantifies / ISpecificationParts / IsFlatBoardElement / явное исключение) | PurchasedGoodsSpecificationTests, PurchasedGoodsSpecItemsTests, ElementSpecCoverageTests, SpecificationCoverageGuardTests (сторож: каждый тип из EveryElementType обязан либо считать себя, либо стоять в поимённом списке исключений с причиной) | Elements/, Pure/Elements/ |
